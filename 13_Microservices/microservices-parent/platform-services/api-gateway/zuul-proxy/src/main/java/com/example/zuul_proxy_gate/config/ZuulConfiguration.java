package com.example.zuul_proxy_gate.config;
...
public class ZuulConfiguration {
    ...
    private static final class ZuulPostProcessor implements BeanPostProcessor {
        ...
        ZuulPostProcessor(RouteLocator routeLocator,
	   ...
	   if (hasErrorController && (bean instanceof ZuulHandlerMapping)) {
	       ...
	       enhancer.setCallbacks(new Callback[]{LookupHandlerMethodInterceptor.INSTANCE,
		      NoOp.INSTANCE});
